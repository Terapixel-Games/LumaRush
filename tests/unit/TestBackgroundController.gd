...
func test_match_pulse_tints_boost_particles_without_recoloring_ambient_particles() -> void:
	...
	assert_that(ambient_after.r).is_equal_approx(ambient_before.r, 0.02)
	assert_that(ambient_after.g).is_equal_approx(ambient_before.g, 0.02)
	assert_that(ambient_after.b).is_equal_approx(ambient_before.b, 0.02)
